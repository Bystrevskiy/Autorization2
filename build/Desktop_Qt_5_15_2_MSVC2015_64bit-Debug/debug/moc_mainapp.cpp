...
QT_MOC_LITERAL(1, 8, 28), // "on_tableWidget_cellActivated"
QT_MOC_LITERAL(2, 37, 0), // ""
QT_MOC_LITERAL(3, 38, 3), // "row"
QT_MOC_LITERAL(4, 42, 6), // "column"
QT_MOC_LITERAL(5, 49, 32) // "on_tableWidget_cellDoubleClicked"

    },
    "MainApp\0on_tableWidget_cellActivated\0"
    "\0row\0column\0on_tableWidget_cellDoubleClicked"
};
...
void MainApp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_tableWidget_cellActivated((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
